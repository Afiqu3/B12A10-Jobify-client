...
const Footer = () => {
  ...
  return (
    <footer
      className="relative bg-[#244034] text-gray-300 mt-12 pt-15 border-t border-white/10 sm:[clip-path:polygon(0_0%,100%_25%,100%_100%,0_100%)] [clip-path:polygon(0_0%,100%_15%,100%_100%,0_100%)]"
    >
      <div className="relative max-w-6xl mx-auto px-6 py-16">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6 text-sm">
            <a href="/privacy" className="hover:text-[#D2F34C] transition">
              Privacy
            </a>
            <a href="/terms" className="hover:text-[#D2F34C] transition">
              Terms
            </a>
            <a href="/cookies" className="hover:text-[#D2F34C] transition">
              Cookies
            </a>
          </div>
        </div>
